...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
							...
							-->
							<img src="img/public-notice-by-UHS.webp" alt="Public Notice by UHS" style="width:100%;">
							<!-- <div>
								<h5><b>Dear Students,</b></h5>

								<p>You are hereby intimated that the <b>second college wise selection list for the admission session 2023-24</b> for the Niazi Medical & Dental College has been displayed by University of Health Sciences Lahore.<br>
								For Further admission process you are requested to contact Niazi Medical & Dental College on the following contact numbers.<br><br>
								
								<b>For Admission Process</b><br>
								Student affairs Department: +92 3011 248 248<br>
								
								<b>For Fee Process</b><br>
								Accounts Department: +92 300 603 8558
								</p>
...
<!-- Modal -->
<div class="modal fade" id="myModalMigration" tabindex="-1" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
							...
							<img src="downloads/Migration_for_Vacant_Seats_NMDC_2024.webp" alt="downloads/Migration_for_Vacant_Seats_NMDC_2024.webp" style="width:100%;">
						</div>
...
<div class="modal fade" id="myModal11" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
							...
							-->
							<img src="img/Check-List-MBBS-BDS-ADMISSIONS-23-24.webp" alt="Admissions Checklist" style="width:100%;">
						</div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
<!--<h3 class="agileinfo_sign"><span></span></h3>-->
<img src="img/img_sm_441.webp" alt="Admissions are Open" style="width:100%;">
						</div>
...
<div class="modal fade" id="myModal5" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
<!--<h3 class="agileinfo_sign"><span></span></h3>-->
<img src="img/img_sm_70.webp" alt="Admissions are Open" style="width:100%;">
						</div>
...
<div class="modal fade" id="myModal6" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
<!--<h3 class="agileinfo_sign"><span></span></h3>-->
<img src="img/img_sm_71.webp" alt="Admissions are Open" style="width:100%;">
						</div>
...
<div class="modal fade" id="myModal7" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
<!--<h3 class="agileinfo_sign"><span></span></h3>-->
<img src="img/img_sm_72.webp" alt="Admissions are Open" style="width:100%;">
						</div>
...
<div class="modal fade" id="#myModalMigration" tabindex="-1" role="dialog">
			...
			<button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="col-md-12 modal_body_left modal_body_left1">
<!--<h3 class="agileinfo_sign"><span></span></h3>-->
<img src="downloads/Migration_for_Vacant_Seats_NMDC_2024.webp" alt="Migration Against Vacant Seats" style="width:100%;">
						</div>

...
$fileName = "WaitingResult_Students_data_" . date('d-m-Y') . ".xls"; 
...
$query = $db->query("SELECT * FROM `students_data` WHERE `matric_year`=0 || `fsc_year`=0 || `mcat_year`=0 ORDER BY `id` ASC");
if($query->num_rows > 0){ 

...
<div class="container-fluid" style="padding:0;">
    ...
    <div style="padding:0;">
        ...
        <a href="exportsaved.php" style="text-decoration:none;">
...
<div class="container-fluid">
    <div class="row" style="padding-top:15px; padding-bottom:15px;">
        <div class="col-md-12">
            <h2 style="font-size:28px;text-align:center; font-family:Constantia, 'Lucida Bright', 'DejaVu Serif', Georgia, serif">VIEW DATA SAVED STUDENTS</h2>
        </div>
    </div>
    <div class="row" style="padding:20px;">
        <table class="table table-bordered" style="text-align:center;">
            ...
            <tbody>
                <?php $count = 1;
                $q = mysqli_query($con, "SELECT * FROM `students_data` WHERE `submit_st`=0 ORDER BY `id` ASC");

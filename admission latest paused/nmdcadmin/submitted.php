...
<div class="container-fluid" style="padding:0;">
    ...
    <div style="padding:0;">
        ...
        <a href="exportsubmitted.php" style="text-decoration:none;">
...
<div class="container-fluid">
    <div class="row" style="padding-top:15px; padding-bottom:15px;">
        <div class="col-md-12">
            <h2 style="font-size:28px;text-align:center; font-family:Constantia, 'Lucida Bright', 'DejaVu Serif', Georgia, serif">VIEW FORM SUBMITTED STUDENTS</h2>
        </div>
    </div>

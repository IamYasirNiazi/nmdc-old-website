...
<strong>Error !</strong> Invalid CNIC.
</div>";
?>
...
<form action="forgotpassz.php" method="POST" id="my-reg-form" class="form-group">
					<div class="container">
					...
					<div class="row">
						<div class="col-md-12 form-group">
							<label>CNIC *</label>
							<input type="text" name="cnic" class="validate_cnic form-control" required placeholder="30493-2840928-3" maxlength="15" autofocus>
						</div>
...
<div class="row">
<div class="col-md-12 form-group">                                     
<button class="btn btn-primary form-control" id="reg_submit" type="submit" name="submit" style="margin-bottom:10px; margin-top:10px;">SEARCH ACCOUNT</button>

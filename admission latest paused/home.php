...
?>
		...
		<div class="row justify-content-center">
			<div  class="col-md-6 col-xs-6">
				<a href="index.php" title="NIAZI MEDICAL AND DENTAL COLLEGE" >
					...
					<h1 style="font-size: 26px;font-weight: bold;margin-top: 30px;color:#181920;" class="">NIAZI MEDICAL &amp; DENTAL COLLEGE SARGODHA</h1>
				</a>
			</div>
	...
	<div class="container pt-5">
		<div class="row gap-5 justify-content-center admission-btns">
			...
			<a href="#" class="col-md-3 col-xs-4 btn btn-info col-md-offset-1" style="padding: 30px 50px;">
			DPT
			</a>
			<a href="#" class="col-md-3 col-xs-4 btn btn-info col-md-offset-1" style="padding: 30px 50px;">
			D-Pharmacy

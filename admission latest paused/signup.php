...
<button class="btn btn-danger" style="margin-top:20px; letter-spacing:1px; word-spacing:2px; margin-bottom:20px;">CREATE YOUR ACCOUNT</button>
</div>
...
<form action="sign_up.php" method="POST" id="my-reg-form" class="form-group">
					...
					<div class="row">
						<div class="col-md-12 form-group">
							...
							<input type="email" name="email" class="form-control" required autocomplete="off" autofocus placeholder="mymail@gmail.com">
						</div>
						<div class="col-md-12 form-group">
							<label>CNIC *</label>
							<input type="text" name="cnic" class="validate_cnic form-control" required autocomplete="off" placeholder="30493-2840928-3">
						</div>
						<div class="col-md-12 form-group">
							<label>Password</label>
							<input type="password" name="pass" class="form-control" required autocomplete="off" placeholder="*******">
						</div>
					</div>

...
<input type="hidden" name="id" value="<?php if(empty($row['id'])){echo "";}else{echo $row['id'];}?>">
					...
					<div class="row" >
						<div class="col-md-6 form-group">
							<label>Your Desired Field of Study *</label>
							<div class="row form-group" >
								<div class="col-md-3">
									<label for="">MBBS</label>
									<input type="radio" name="dept" value="mbbs" class="form-control-radio" <?php if(empty($row['mbbs'])){echo "checked";}else{if($row['dept']=="mbbs"){ echo "checked"; }}?>>
								</div>
								<div class="col-md-3">
									<label>BDS</label>
									<input type="radio" name="dept" value="bds" class="form-control-radio" <?php if(empty($row['bds'])){echo "";}else{if($row['dept']=="bds"){ echo "checked"; }}?>>
								</div>
							</div>
						</div>
					</div>

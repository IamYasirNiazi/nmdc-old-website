...
<form action="forgotpassbz.php" method="POST" id="my-reg-form" class="form-group">
					<div class="container">
...
<div class="row">
<div class="col-md-12 form-group">                                     
<button class="btn btn-primary form-control" id="reg_submit" type="submit" name="submit" style="margin-bottom:10px; margin-top:10px;">VERIFY ACCOUNT</button>

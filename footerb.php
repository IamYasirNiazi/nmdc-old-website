            ...
            <div class="col-md-4">
              <div class="probootstrap-footer-widget">
                ...
                <ul class="probootstrap-contact-info">
                  ...
                  <li>For Doctor of Pharmacy +923-071-248-248</li>
                </ul>
              </div>
            </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 text-left">
								  ...
								  <div class="sms-button-homec sidec" style="opacity: 0;">
				  <a href="admission/" target="_blank">Apply Online</a>
				  </div> 
				  
				  <div class="visible-xs sms-button-homed sided"  style="opacity: 0;">
				  <a href="admission/" target="_blank">Apply Online</a>
				  </div>

                <p>&copy; 2018-<?php echo date('Y'); ?> <a href="http://www.nmdc.edu.pk/">NIAZI MEDICAL AND DENTAL COLLEGE</a>. All Rights Reserved. <br>Designed &amp; Developed with <i class="icon icon-heart"></i> by <a href="http://www.nmdc.edu.pk" target="_blank">Sarosh Khan (92)324-7301987</a>
